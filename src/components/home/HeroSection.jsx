  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mb-10 max-w-3xl text-base leading-8 text-white/65 sm:text-lg md:text-xl lg:text-2xl lg:leading-9">
        ForgePass LA combines live city intelligence, tourism discovery,
        transportation awareness, rewards, event access, and local experiences
        into one unified platform built for the 2028 Olympic expansion.
      </p>
